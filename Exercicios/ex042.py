...
if r1+r2>r3 and r1+r3>r2 and r2+r3>r1:
    ...
    if r1 == r2 == r3:
        print('Seu triângulo é do tipo EQUILATERO, por possuir todos os lados iguais!')
    elif r1 == r2 != r3 or r1 == r3 != r2 or r2 == r3 != r1:
        print('Seu triângulo é do tipo ISÓSCELES, por possuir dois lados iguais!')
    else:
        print('Seu triângulo é do tipo ESCALENO, por possuir todos os lados diferentes!')
else:
